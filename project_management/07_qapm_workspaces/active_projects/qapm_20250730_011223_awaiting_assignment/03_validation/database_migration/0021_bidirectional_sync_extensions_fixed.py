...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Add indexes separately to avoid ModelState name issues
        migrations.AddIndex(
            model_name='syncop',
            index=models.Index(fields=['fabric', 'status'], name='hnp_syncop_fabric_status_idx'),
        ),
        migrations.AddIndex(
            model_name='syncop',
            index=models.Index(fields=['operation_type', 'status'], name='hnp_syncop_type_status_idx'),
        ),
        migrations.AddIndex(
            model_name='syncop',
            index=models.Index(fields=['started_at'], name='hnp_syncop_started_idx'),
        ),
        migrations.AddIndex(
            model_name='syncop',
            index=models.Index(fields=['fabric', 'operation_type', 'started_at'], name='hnp_syncop_fab_type_time_idx'),
        ),
