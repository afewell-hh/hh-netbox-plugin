    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-started_at'],
                'indexes': [
                    models.Index(fields=['fabric', 'status'], name='hnp_syncop_fab_status_idx'),
                    models.Index(fields=['operation_type', 'status'], name='hnp_syncop_optype_status_idx'),
                    models.Index(fields=['started_at'], name='hnp_syncop_started_idx'),
                    models.Index(fields=['fabric', 'operation_type', 'started_at'], name='hnp_syncop_fab_type_start_idx'),
                ],
            },
        ),
